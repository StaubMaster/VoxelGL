...
Voxel::RenderData Voxel::RenderData::compress(Undex3D vox_idx, int tex_idx, char tex_info)
{
	...
	else if (side == 0b101)
	{
		...
		//tex_x_min = 0.50f; tex_x_max = 0.75f; tex_y_min = 0.5f; tex_y_max = 1.0f;	//	↘
		//tex_x_min = 0.50f; tex_x_max = 0.75f; tex_y_min = 1.0f; tex_y_max = 0.5f;	//	↙
		//tex_x_min = 0.75f; tex_x_max = 0.50f; tex_y_min = 1.0f; tex_y_max = 0.5f;	//	↖
	}
...
void Voxel::FaceYn(RenderData * data, unsigned int & idx, Undex3D vox_idx, int tex_idx)
{
	...
	data[idx + 1] = RenderData::compress(vox_idx + Undex3D(0, 0, 1), tex_idx, 0b01001);
	data[idx + 2] = RenderData::compress(vox_idx + Undex3D(1, 0, 0), tex_idx, 0b01010);
	data[idx + 3] = RenderData::compress(vox_idx + Undex3D(1, 0, 0), tex_idx, 0b01010);
	data[idx + 4] = RenderData::compress(vox_idx + Undex3D(0, 0, 1), tex_idx, 0b01001);
...
void Voxel::FaceYp(RenderData * data, unsigned int & idx, Undex3D vox_idx, int tex_idx)
{
	...
	data[idx + 1] = RenderData::compress(vox_idx + Undex3D(1, 0, 0), tex_idx, 0b01110);
	data[idx + 2] = RenderData::compress(vox_idx + Undex3D(0, 0, 1), tex_idx, 0b01101);
	data[idx + 3] = RenderData::compress(vox_idx + Undex3D(0, 0, 1), tex_idx, 0b01101);
	data[idx + 4] = RenderData::compress(vox_idx + Undex3D(1, 0, 0), tex_idx, 0b01110);
...
void Voxel::FaceZn(RenderData * data, unsigned int & idx, Undex3D vox_idx, int tex_idx)
{
	...
	data[idx + 1] = RenderData::compress(vox_idx + Undex3D(1, 0, 0), tex_idx, 0b10010);
	data[idx + 2] = RenderData::compress(vox_idx + Undex3D(0, 1, 0), tex_idx, 0b10001);
	data[idx + 3] = RenderData::compress(vox_idx + Undex3D(0, 1, 0), tex_idx, 0b10001);
	data[idx + 4] = RenderData::compress(vox_idx + Undex3D(1, 0, 0), tex_idx, 0b10010);
...
void Voxel::FaceZp(RenderData * data, unsigned int & idx, Undex3D vox_idx, int tex_idx)
{
	...
	data[idx + 1] = RenderData::compress(vox_idx + Undex3D(0, 1, 0), tex_idx, 0b10101);
	data[idx + 2] = RenderData::compress(vox_idx + Undex3D(1, 0, 0), tex_idx, 0b10110);
	data[idx + 3] = RenderData::compress(vox_idx + Undex3D(1, 0, 0), tex_idx, 0b10110);
	data[idx + 4] = RenderData::compress(vox_idx + Undex3D(0, 1, 0), tex_idx, 0b10101);
