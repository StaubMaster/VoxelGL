...
uint32	Chunk::calc_CRC() const
{
	...
	lookupIndex = (crc32 ^ ((Type >> 0) & 0xFF)) & 0xFF;
	crc32 = (crc32 >> 8) ^ CRC32_Table[lookupIndex];
	lookupIndex = (crc32 ^ ((Type >> 1) & 0xFF)) & 0xFF;
	crc32 = (crc32 >> 8) ^ CRC32_Table[lookupIndex];
	lookupIndex = (crc32 ^ ((Type >> 2) & 0xFF)) & 0xFF;
	crc32 = (crc32 >> 8) ^ CRC32_Table[lookupIndex];
	lookupIndex = (crc32 ^ ((Type >> 3) & 0xFF)) & 0xFF;
	crc32 = (crc32 >> 8) ^ CRC32_Table[lookupIndex];
